...
export const HeroSection = ({ data, birthdayLabel, photoAlt }: HeroSectionProps) => {
  return (
    <header className="relative overflow-hidden bg-gradient-to-b from-blush via-pink-light/40 to-blush py-16 sm:py-24">
      <div
